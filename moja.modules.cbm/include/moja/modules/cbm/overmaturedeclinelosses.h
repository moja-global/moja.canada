#ifndef MOJA_MODULES_CBM_OVERMATUREDECLINELOSSES_H_
#define MOJA_MODULES_CBM_OVERMATUREDECLINELOSSES_H_
...
namespace cbm {
    ...
    public:
        OvermatureDeclineLosses() : _lossesPresent(false), _merchToStemSnags(0.0),
                                    _foliageToAGVeryFast(0.0), _otherToBranchSnag(0.0),
                                    _otherToAGFast(0.0), _coarseRootToAGFast(0.0),
                                    _coarseRootToBGFast(0.0), _fineRootToAGVeryFast(0.0),
                                    _fineRootToBGVeryFast(0.0) {};
