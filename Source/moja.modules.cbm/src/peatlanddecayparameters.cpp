...
namespace moja {
	namespace modules {
		namespace cbm {
			...
			* PeatlandDecayParameters._ksr,PeatlandDecayParameters._kfm,PeatlandDecayParameters._ka,PeatlandDecayParameters._kc,PeatlandDecayParameters._kpp, \n
			...
			* PeatlandDecayParameters._Q10sf,PeatlandDecayParameters._Q10sr,PeatlandDecayParameters._Q10fm,PeatlandDecayParameters._Q10a,PeatlandDecayParameters._Q10pp, \n
			...
			* PeatlandDecayParameters._akpp as computeAppliedDecayRate(PeatlandDecayParameters._kpp, PeatlandDecayParameters._Q10pp)
			*
			...
			* ************************/
			void PeatlandDecayParameters::updateAppliedDecayParameters(double meanAnnualTemperature) {
				...
				_akpp = computeAppliedDecayRate(_kpp, _Q10pp);
			}
