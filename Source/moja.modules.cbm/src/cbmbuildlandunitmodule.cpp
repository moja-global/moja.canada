...
namespace moja {
	namespace modules {
		namespace cbm {
			...
			* Add CBMBuildLandUnitModule._initialCSet and all mask variables to CBMBuildLandUnitModule._maskVars
			*
			* @return void
			* ************************/
			...
			/**
			*
			* Assign CBMBuildLandUnitModule._cset the value of CBMBuildLandUnitModule._initialCSet \n
